...
import (
	...
	"github.com/takuya-okada-01/badminist/api/interface_adaptor_if/repository_if.go"
)
...
type commandProcessor struct {
	communityRepo repository_if.CommunityRepository
	userRepo      repository_if.UserRepository
}
